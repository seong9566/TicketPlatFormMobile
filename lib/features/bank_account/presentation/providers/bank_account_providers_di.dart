...
import 'package:ticket_platform_mobile/features/bank_account/domain/usecases/confirm_verification_usecase.dart';
...
@riverpod
RequestVerificationUsecase requestVerificationUsecase(Ref ref) {
  return RequestVerificationUsecase(ref.watch(bankAccountRepositoryProvider));
}

@riverpod
ConfirmVerificationUsecase confirmVerificationUsecase(Ref ref) {
  return ConfirmVerificationUsecase(ref.watch(bankAccountRepositoryProvider));
}
