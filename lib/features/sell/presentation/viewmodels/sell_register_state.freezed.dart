...
as List<SellFeatureUiModel>,selectedFeatureIds: null == selectedFeatureIds ? _self.selectedFeatureIds : selectedFeatureIds // ignore: cast_nullable_to_non_nullable
...
class _SellRegisterState extends SellRegisterState {
  const _SellRegisterState({final  List<SellEventUiModel> events = const [], this.eventsTotalCount = 0, this.eventsCurrentPage = 1, this.eventsTotalPages = 0, this.eventsHasMore = false, this.eventsKeyword = '', this.selectedEvent, final  List<SellScheduleUiModel> schedules = const [], this.selectedDate, this.selectedSchedule, this.seatOptions, this.selectedGradeId, this.selectedLocationId, this.selectedAreaId, this.seatDetail = '', this.seatFloor, this.seatRowType, this.quantity = 1, this.isConsecutive = false, this.originalPrice, this.price = '', final  List<SellFeatureUiModel> features = const [], final  List<int> selectedFeatureIds = const [], this.selectedTradeMethodId, this.hasTicket = true, this.description = '', final  List<File> images = const [], this.isLoading = false, this.errorMessage}): _events = events,_schedules = schedules,_features = features,_selectedFeatureIds = selectedFeatureIds,_images = images,super._();
...
as List<SellFeatureUiModel>,selectedFeatureIds: null == selectedFeatureIds ? _self._selectedFeatureIds : selectedFeatureIds // ignore: cast_nullable_to_non_nullable
as List<int>,selectedTradeMethodId: freezed == selectedTradeMethodId ? _self.selectedTradeMethodId : selectedTradeMethodId // ignore: cast_nullable_to_non_nullable
as int?,hasTicket: null == hasTicket ? _self.hasTicket : hasTicket // ignore: cast_nullable_to_non_nullable
as bool,description: null == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
