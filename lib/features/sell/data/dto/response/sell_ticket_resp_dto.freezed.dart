...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SellTicketRegisterRespDto&&(identical(other.ticketId, ticketId) || other.ticketId == ticketId)&&(identical(other.status, status) || other.status == status)&&(identical(other.message, message) || other.message == message));
}
...
@override
String toString() {
  return 'SellTicketRegisterRespDto(ticketId: $ticketId, status: $status, message: $message)';
}
...
class _SellTicketRegisterRespDto implements SellTicketRegisterRespDto {
  const _SellTicketRegisterRespDto({required this.ticketId, required this.status, required this.message});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SellTicketRegisterRespDto&&(identical(other.ticketId, ticketId) || other.ticketId == ticketId)&&(identical(other.status, status) || other.status == status)&&(identical(other.message, message) || other.message == message));
}
