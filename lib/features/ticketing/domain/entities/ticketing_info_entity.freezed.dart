...
mixin _$TicketingTicketEntity {
 ...
 int get ticketId; String get ticketTitle; String get seatInfo; String get seatType; int get price; int get originalPrice; List<String> get seatFeatures; String get description; DateTime get createdAt; TicketingSellerEntity get seller;
...
@override
String toString() {
  return 'TicketingTicketEntity(ticketId: $ticketId, ticketTitle: $ticketTitle, seatInfo: $seatInfo, seatType: $seatType, price: $price, originalPrice: $originalPrice, seatFeatures: $seatFeatures, description: $description, createdAt: $createdAt, seller: $seller)';
}
...
@useResult
$Res call({
 int ticketId, String ticketTitle, String seatInfo, String seatType, int price, int originalPrice, List<String> seatFeatures, String description, DateTime createdAt, TicketingSellerEntity seller
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int ticketId,  String ticketTitle,  String seatInfo,  String seatType,  int price,  int originalPrice,  List<String> seatFeatures,  String description,  DateTime createdAt,  TicketingSellerEntity seller)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TicketingTicketEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int ticketId,  String ticketTitle,  String seatInfo,  String seatType,  int price,  int originalPrice,  List<String> seatFeatures,  String description,  DateTime createdAt,  TicketingSellerEntity seller)  $default,) {final _that = this;
switch (_that) {
case _TicketingTicketEntity():
return $default(_that.ticketId,_that.ticketTitle,_that.seatInfo,_that.seatType,_that.price,_that.originalPrice,_that.seatFeatures,_that.description,_that.createdAt,_that.seller);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int ticketId,  String ticketTitle,  String seatInfo,  String seatType,  int price,  int originalPrice,  List<String> seatFeatures,  String description,  DateTime createdAt,  TicketingSellerEntity seller)?  $default,) {final _that = this;
switch (_that) {
case _TicketingTicketEntity() when $default != null:
return $default(_that.ticketId,_that.ticketTitle,_that.seatInfo,_that.seatType,_that.price,_that.originalPrice,_that.seatFeatures,_that.description,_that.createdAt,_that.seller);case _:
  return null;
