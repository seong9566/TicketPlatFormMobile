...
mixin _$TicketingTicketDetailUiModel {
 ...
 int get ticketId; String? get performanceTitle; String? get performanceImageUrl; DateTime? get performanceDate; String? get location; String get gradeName; String? get seatInfo; int get price; int get quantity; int get totalPrice; int get originalPrice; List<String> get tags; TicketingSellerUiModel get seller; String? get description; List<String> get images; String get ticketCountInfo; List<String> get transactionFeatures; bool get isFavorited; String? get tradeMethodName; bool? get hasTicket; bool? get isConsecutive;
...
@useResult
$Res call({
 int ticketId, String? performanceTitle, String? performanceImageUrl, DateTime? performanceDate, String? location, String gradeName, String? seatInfo, int price, int quantity, int totalPrice, int originalPrice, List<String> tags, TicketingSellerUiModel seller, String? description, List<String> images, String ticketCountInfo, List<String> transactionFeatures, bool isFavorited, String? tradeMethodName, bool? hasTicket, bool? isConsecutive
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int ticketId,  String? performanceTitle,  String? performanceImageUrl,  DateTime? performanceDate,  String? location,  String gradeName,  String? seatInfo,  int price,  int quantity,  int totalPrice,  int originalPrice,  List<String> tags,  TicketingSellerUiModel seller,  String? description,  List<String> images,  String ticketCountInfo,  List<String> transactionFeatures,  bool isFavorited,  String? tradeMethodName,  bool? hasTicket,  bool? isConsecutive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TicketingTicketDetailUiModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int ticketId,  String? performanceTitle,  String? performanceImageUrl,  DateTime? performanceDate,  String? location,  String gradeName,  String? seatInfo,  int price,  int quantity,  int totalPrice,  int originalPrice,  List<String> tags,  TicketingSellerUiModel seller,  String? description,  List<String> images,  String ticketCountInfo,  List<String> transactionFeatures,  bool isFavorited,  String? tradeMethodName,  bool? hasTicket,  bool? isConsecutive)  $default,) {final _that = this;
switch (_that) {
case _TicketingTicketDetailUiModel():
return $default(_that.ticketId,_that.performanceTitle,_that.performanceImageUrl,_that.performanceDate,_that.location,_that.gradeName,_that.seatInfo,_that.price,_that.quantity,_that.totalPrice,_that.originalPrice,_that.tags,_that.seller,_that.description,_that.images,_that.ticketCountInfo,_that.transactionFeatures,_that.isFavorited,_that.tradeMethodName,_that.hasTicket,_that.isConsecutive);case _:
  throw StateError('Unexpected subclass');
