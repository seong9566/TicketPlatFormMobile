...
import 'package:ticket_platform_mobile/features/artist/presentation/view/widgets/artist_info_header.dart';
import 'package:ticket_platform_mobile/features/artist/presentation/view/widgets/performance_card.dart';
import 'package:ticket_platform_mobile/features/artist/presentation/view/widgets/performance_filter_bar.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          SliverToBoxAdapter(
            child: ArtistInfoHeader(
              name: _artistInfo['name']!,
              imageUrl: _artistInfo['imageUrl']!,
              followerCount: _artistInfo['followerCount']!,
              genre: _artistInfo['genre']!,
            ),
          ),
