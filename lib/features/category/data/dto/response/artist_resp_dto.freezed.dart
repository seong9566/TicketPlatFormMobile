...
@override
String toString() {
  return 'ArtistRespDto(id: $id, name: $name, englishName: $englishName, title: $title, imageUrl: $imageUrl, isNew: $isNew, isHot: $isHot, isSoldOut: $isSoldOut, ticketCount: $ticketCount)';
}
...
/// @nodoc
abstract mixin class $ArtistRespDtoCopyWith<$Res>  {
  factory $ArtistRespDtoCopyWith(ArtistRespDto value, $Res Function(ArtistRespDto) _then) = _$ArtistRespDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ArtistRespDtoCopyWithImpl<$Res>
    implements $ArtistRespDtoCopyWith<$Res> {
  _$ArtistRespDtoCopyWithImpl(this._self, this._then);

  final ArtistRespDto _self;
  final $Res Function(ArtistRespDto) _then;
...
/// Adds pattern-matching-related methods to [ArtistRespDto].
extension ArtistRespDtoPatterns on ArtistRespDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ArtistRespDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ArtistRespDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ArtistRespDto value)  $default,){
final _that = this;
switch (_that) {
case _ArtistRespDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ArtistRespDto value)?  $default,){
final _that = this;
switch (_that) {
case _ArtistRespDto() when $default != null:
return $default(_that);case _:
...
class _ArtistRespDto implements ArtistRespDto {
  const _ArtistRespDto({required this.id, required this.name, required this.englishName, required this.title, required this.imageUrl, this.isNew = false, this.isHot = false, this.isSoldOut = false, this.ticketCount = 0});
  factory _ArtistRespDto.fromJson(Map<String, dynamic> json) => _$ArtistRespDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$ArtistRespDtoCopyWith<_ArtistRespDto> get copyWith => __$ArtistRespDtoCopyWithImpl<_ArtistRespDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ArtistRespDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ArtistRespDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.englishName, englishName) || other.englishName == englishName)&&(identical(other.title, title) || other.title == title)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.isNew, isNew) || other.isNew == isNew)&&(identical(other.isHot, isHot) || other.isHot == isHot)&&(identical(other.isSoldOut, isSoldOut) || other.isSoldOut == isSoldOut)&&(identical(other.ticketCount, ticketCount) || other.ticketCount == ticketCount));
}
...
/// @nodoc
abstract mixin class _$ArtistRespDtoCopyWith<$Res> implements $ArtistRespDtoCopyWith<$Res> {
  factory _$ArtistRespDtoCopyWith(_ArtistRespDto value, $Res Function(_ArtistRespDto) _then) = __$ArtistRespDtoCopyWithImpl;
@override @useResult
$Res call({
 int id, String name, String englishName, String title, String imageUrl, bool isNew, bool isHot, bool isSoldOut, int ticketCount
});
...
/// @nodoc
class __$ArtistRespDtoCopyWithImpl<$Res>
    implements _$ArtistRespDtoCopyWith<$Res> {
  __$ArtistRespDtoCopyWithImpl(this._self, this._then);

  final _ArtistRespDto _self;
  final $Res Function(_ArtistRespDto) _then;
