...
@override
String toString() {
  return 'ChangePasswordState(isLoading: $isLoading, isSuccess: $isSuccess, errorMessage: $errorMessage, successMessage: $successMessage)';
}
...
class _ChangePasswordState implements ChangePasswordState {
  const _ChangePasswordState({this.isLoading = false, this.isSuccess = false, this.errorMessage, this.successMessage});
