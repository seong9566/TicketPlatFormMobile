...
mixin _$MyProfileEntity {
 ...
 int get userId; String get nickname; String? get profileImageUrl; String? get bio; double get mannerTemperature; int get totalTradeCount;
...
@override
int get hashCode => Object.hash(runtimeType,userId,nickname,profileImageUrl,bio,mannerTemperature,totalTradeCount);

@override
String toString() {
  return 'MyProfileEntity(userId: $userId, nickname: $nickname, profileImageUrl: $profileImageUrl, bio: $bio, mannerTemperature: $mannerTemperature, totalTradeCount: $totalTradeCount)';
}
...
@useResult
$Res call({
 int userId, String nickname, String? profileImageUrl, String? bio, double mannerTemperature, int totalTradeCount
});
...
/// Create a copy of MyProfileEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? nickname = null,Object? profileImageUrl = freezed,Object? bio = freezed,Object? mannerTemperature = null,Object? totalTradeCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int userId,  String nickname,  String? profileImageUrl,  String? bio,  double mannerTemperature,  int totalTradeCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MyProfileEntity() when $default != null:
return $default(_that.userId,_that.nickname,_that.profileImageUrl,_that.bio,_that.mannerTemperature,_that.totalTradeCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int userId,  String nickname,  String? profileImageUrl,  String? bio,  double mannerTemperature,  int totalTradeCount)  $default,) {final _that = this;
switch (_that) {
case _MyProfileEntity():
return $default(_that.userId,_that.nickname,_that.profileImageUrl,_that.bio,_that.mannerTemperature,_that.totalTradeCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int userId,  String nickname,  String? profileImageUrl,  String? bio,  double mannerTemperature,  int totalTradeCount)?  $default,) {final _that = this;
switch (_that) {
case _MyProfileEntity() when $default != null:
return $default(_that.userId,_that.nickname,_that.profileImageUrl,_that.bio,_that.mannerTemperature,_that.totalTradeCount);case _:
  return null;
...
class _MyProfileEntity implements MyProfileEntity {
  const _MyProfileEntity({required this.userId, required this.nickname, this.profileImageUrl, this.bio, required this.mannerTemperature, required this.totalTradeCount});
...
/// Create a copy of MyProfileEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? nickname = null,Object? profileImageUrl = freezed,Object? bio = freezed,Object? mannerTemperature = null,Object? totalTradeCount = null,}) {
